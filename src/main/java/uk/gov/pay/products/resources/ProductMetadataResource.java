...
public class ProductMetadataResource {
    ...
    @Inject
    public ProductMetadataResource(ProductFactory productFactory, ProductsMetadataFactory metadataFactory,
    ...
    @POST
    @Path("/products/{productExternalId}/metadata")
    ...
    public Response createMetadata(@PathParam("productExternalId") String productExternalId, JsonNode payload) {
        ...
        return requestValidator.validateCreateRequest(payload, metadataList)
