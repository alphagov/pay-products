...
public class PaymentResourceTest extends IntegrationTest {
    ...
    @Test
    public void givenANonExistingExternalPaymentId_shouldReturn404() throws Exception {
    ...
    @Test
    public void givenAnExistingProductExternalId_shouldFindAndReturnPayments() throws Exception {
